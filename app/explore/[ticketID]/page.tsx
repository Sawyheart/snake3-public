...
export default async function SnakeTicketPageExplore({ params: { ticketID } }: SnakeTicketProps) {
  const snake_data = await getSnakeData(+ticketID)
  return <SnakeTicketPage params={{ ticketID }} snakeData={snake_data} />
}
